...
#subjectkey will be renamed to NDAR_ID in all instances and is the main subject identifier 
...
#in terminal
cd /Users/amirhosseinmodabbernia/Documents/Phd/Thesis /ABCD/ABCD_Scripts
...
fun_conn<-fun_conn[fun_conn$rsfmri_c_ngd_ntpoints>375,]
